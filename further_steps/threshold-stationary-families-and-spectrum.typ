...
= Threshold stationary families and amplitude spectrum

#emph[Detailed threshold analysis extracted from the main article. The main
paper retains only the concise stationary-family separation, highest-crest
selection, and balanced-threshold corollary.]

Let $1<n<d$, let $x in RR / ZZ$, write $theta=2 pi x$, and define
...
For an anchored crest branch, set $A_i (k)=F_k (X_i (k))$. The deferred
trajectory analysis supplies
...
=
-
((partial_(k x) F_k (X_i (k)))^2) / H_k (X_i (k)).
$ <A-second-deriv>
